...
Wird diese Annahme auf die Größen der Kontinuitätsgleichung \eqref{eqn:konti}
...
\intertext{mit}
 \ket{c_\alpha^n}=\sum_{k=1}^\infty c_{\alpha,k}^n \ket{\varphi_k} %phi beliebiges orthonomal set auf h_0
\end{align}
dargestellt werden.
