...
#            farbe=np.linspace(0,1,10000)
        params , cov = curve_fit(gerade,Frequenz[10:50],np.real(I_bar[10:50]))
        plt.plot(Frequenz,I_bar,  '-'+farbe[e],alpha=0.75, label=r'$\langle I \rangle$ für $E_0=$'+str(Energien[e]/10000))
        plt.plot(Frequenz,gerade(Frequenz,*params),':'+farbe[e],label=r'Fit für $E_0=$'+str(Energien[e]/10000))
