...
#            farbe=np.linspace(0,1,10000)
        ...
        print('a=',params)
        plt.plot(Frequenz,I_bar_ges,'-'+farbe[e],alpha=0.25, label=r'$E_0=$'+str(Energien[e]/10000)+r'$\,J/d symup{e}$')
        plt.plot(Frequenz,gerade(Frequenz,*params),':'+farbe[e],label=r'$E_0=$'+str(Energien[e]/10000)+r'$\,J/d symup{e}$ Fit')
