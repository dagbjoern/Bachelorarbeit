...
for a in tqdm(range(int(np.size(Potential)))):
    ...
    for e in tqdm(range(int(np.size(Energien)))):
        ...
        for f in tqdm(range(int(np.size(Frequenz)))):
            ...
            Figure_Zahler=1+Figure_Zahler
#            plt.title('Orthogonalität fur n=' + str(Anzahl_N[l]) + '\n w=' + str(Frequenz[f]) + ' E=' +str(Energien[e]/10000) + ' a=' +str(Potential[a]/100) )
            plt.plot(Anzahl_N, werte_2[0,:].real,'x-y',alpha=0.5,label=r'$\langle\Phi_2|\Phi_1\rangle$' )
            plt.plot(Anzahl_N, werte_2[1,:].real,'x-r',alpha=0.5,label=r'$\langle\Phi_2|\Phi_2\rangle$' )
            plt.plot(Anzahl_N, werte_2[2,:].real,'x-g',alpha=0.5,label=r'$\langle\Phi_2|\Phi_3\rangle$' )
            plt.plot(Anzahl_N, werte_2[3,:].real,'x-b',alpha=0.5,label=r'$\langle\Phi_2|\Phi_4\rangle$' )
            ...
            Figure_Zahler=1+Figure_Zahler
#            plt.title('Orthogonalität fur n=' + str(Anzahl_N[l]) + '\n w=' + str(Frequenz[f]) + ' E=' +str(Energien[e]/10000) + ' a=' +str(Potential[a]/100) )
            plt.plot(Anzahl_N, werte_3[0,:].real,'x-y',alpha=0.5,label=r'$\langle\Phi_3|\Phi_1\rangle$' )
            plt.plot(Anzahl_N, werte_3[1,:].real,'x-r',alpha=0.5,label=r'$\langle\Phi_3|\Phi_1\rangle$' )
            plt.plot(Anzahl_N, werte_3[2,:].real,'x-g',alpha=0.5,label=r'$\langle\Phi_3|\Phi_1\rangle$' )
            plt.plot(Anzahl_N, werte_3[3,:].real,'x-b',alpha=0.5,label=r'$\langle\Phi_3|\Phi_1\rangle$' )
            # plt.ylim(-Frequenz/2,Frequenz/2)
            plt.ylim(-1.5,1.5)
            plt.xlabel('N')
            plt.legend(loc='best')
            ...
            Figure_Zahler=1+Figure_Zahler
#            plt.title('Orthogonalität fur n=' + str(Anzahl_N[l]) + '\n w=' + str(Frequenz[f]) + ' E=' +str(Energien[e]/10000) + ' a=' +str(Potential[a]/100) )
            plt.plot(Anzahl_N, werte_4[0,:].real,'x-y',alpha=0.5,label=r'$\langle\Phi_4|\Phi_1\rangle$' )
            plt.plot(Anzahl_N, werte_4[1,:].real,'x-r',alpha=0.5,label=r'$\langle\Phi_4|\Phi_2\rangle$' )
            plt.plot(Anzahl_N, werte_4[2,:].real,'x-g',alpha=0.5,label=r'$\langle\Phi_4|\Phi_3\rangle$' )
            plt.plot(Anzahl_N, werte_4[3,:].real,'x-b',alpha=0.5,label=r'$\langle\Phi_4|\Phi_4\rangle$' )
            # plt.ylim(-Frequenz/2,Frequenz/2)
            plt.ylim(-1.5,1.5)
            plt.legend(loc='best')
            plt.xlabel('N')
