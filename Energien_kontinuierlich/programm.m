...
Energien=linspace(0,4,1000)


b = 'cool'
Gitterkonstante=1
Phasenverschiebung=0
Anzahl=6       #Anzahl der Perioden
...
#function H_f=H_F(H_0,E,phi,r1,r2,Anzahl)
    ...
    save(['Parameter/Parameter_fur_a=' num2str(Potential(i)*100) '_w=' num2str(Frequenz(l)*1000) '.txt'],'Parameter')
    save(['build/Eigenwerte_fur_a=' num2str(Potential(i)*100) '_w=' num2str(Frequenz(l)*1000) '.txt'],'eigenwerte')
  end
end
